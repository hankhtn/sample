...
Namespace DiagramDemo
    Public NotInheritable Class ProhibitingActions1Example
        ...
        Public Shared Function Run() As FrameworkElement
            ...
            AddHandler diagram.QueryItemsAction, Sub(sender, e)
                ...
                CaseLabel1:
                    If e.Items.OfType(Of DiagramShape)().Any(Function(x) x.Content = "Non-movable") Then
                        e.Allow = False
                    End If
                Case ItemsActionKind.Resize
                    If e.Items.OfType(Of DiagramShape)().Any(Function(x) x.Content = "Non-resizable") Then
                        e.Allow = False
                    End If
                Case ItemsActionKind.Rotate
                    If e.Items.OfType(Of DiagramShape)().Any(Function(x) x.Content = "Non-rotatable") Then
                        e.Allow = False
                    End If
                End Select
            End Sub
