...
namespace PrintingDemo.Tests {
    public class PrintingCheckAllDemosFixture : CheckAllDemosFixture {
        protected override void CreateSetCurrentDemoActions(DemoModuleDescription module, bool checkMemoryLeaks) {
            base.CreateSetCurrentDemoActions(module, checkMemoryLeaks);
            DispatchBusyWait(DocumentBuildCompletedConditionFactory.Create(this));
            Dispatch(delegate() {
