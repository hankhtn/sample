...
Namespace SchedulingDemo.ViewModels
    ...
    Public Class OutlookExchangeOptionsWindowViewModel
        ...
        Private ReadOnly Property IsCancelForRecurring() As Boolean
            Get
                Return Object.Equals(UsedAppointmentType, DevExpress.XtraScheduler.UsedAppointmentType.Recurring)
            End Get
        End Property
        Private ReadOnly Property IsCancelForNonRecurring() As Boolean
            Get
                Return Object.Equals(UsedAppointmentType, DevExpress.XtraScheduler.UsedAppointmentType.NonRecurring)
            End Get
        End Property
        ...
        Private Sub Import()
            Dim importer As New OutlookImporter(scheduler)
        ...
        End Sub
        Private Sub Export()
            Dim exporter As New OutlookExporter(scheduler)
        ...
        Private Sub OnAppointmentItemSynchronizing(ByVal sender As Object, ByVal args As AppointmentItemSynchronizingEventArgs)
            ...
            If args.Appointment Is Nothing Then
                Return
            End If
