...
Namespace DevExpress.SalesDemo.Wpf.ViewModel
    Public Class PerformanceBarChartViewModel
        ...
        Public Shared Shadows Function Create(ByVal moduleType As String, ByVal mode As PerformanceViewMode) As PerformanceBarChartViewModel
            Return ViewModelSource.Create(Function() New PerformanceBarChartViewModel(moduleType, mode))
        End Function
        Protected Sub New()
            Me.New(Modules.Products, PerformanceViewMode.Daily)
        End Sub
        ...
        Protected Overrides Sub ValidateMode(ByVal moduleType As String, ByVal mode As PerformanceViewMode)
            If moduleType = Modules.Products OrElse moduleType = Modules.Sectors OrElse moduleType = Modules.Regions Then
                Return
            End If
