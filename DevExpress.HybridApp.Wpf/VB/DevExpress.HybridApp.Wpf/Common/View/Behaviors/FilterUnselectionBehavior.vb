...
Namespace DevExpress.DevAV
    Public Class FilterUnselectionBehavior
        ...
        Private Sub OnSelectedFilterChanged()
            If AssociatedObject Is Nothing OrElse AssociatedObject.ItemsSource Is Nothing OrElse SelectedFilter Is TileBarItemInternal Then
                Return
            End If
        ...
        Protected Overrides Sub OnAttached()
            MyBase.OnAttached()
            BindingOperations.SetBinding(Me, FilterUnselectionBehavior.TileBarItemInternalProperty, New Binding("SelectedItem") With {.Source = AssociatedObject, .Mode = BindingMode.OneWay})
            OnSelectedFilterChanged()
        End Sub
        Protected Overrides Sub OnDetaching()
            MyBase.OnDetaching()
            BindingOperations.ClearBinding(Me, FilterUnselectionBehavior.TileBarItemInternalProperty)
        End Sub
