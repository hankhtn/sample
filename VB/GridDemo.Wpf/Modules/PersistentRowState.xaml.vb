...
Namespace GridDemo
    ...
    <DevExpress.Xpf.DemoBase.CodeFile("ModuleResources/PersistentRowStateTemplates.xaml"), DevExpress.Xpf.DemoBase.CodeFile("ModuleResources/PersistentRowStateClasses.(cs)")>
