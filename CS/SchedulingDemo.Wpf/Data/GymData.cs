...
namespace SchedulingDemo {
    public class GymData {
        ...
        static readonly Training[] kindOfTraining = {
            new Training() { Id = TrainingKind.Bodybuilding, Name = "Bodybuilding", Color = Color.FromRgb(0xC1, 0xF4, 0x9C)},
            new Training() { Id = TrainingKind.Yoga, Name = "YOGA" , Color = Color.FromRgb(0xFF, 0xC2, 0xBE),
                Description = "Yoga is a group of physical, mental, and spiritual practices or disciplines."
            },
            new Training() { Id = TrainingKind.Zumba, Name = "Zumba", Color = Color.FromRgb(0xA8, 0xD5, 0xFF),
                Description = "Zumba involves dance and aerobic movements performed to energetic music."
            },
            new Training() { Id = TrainingKind.Boxing, Name = "Boxing", Color = Color.FromRgb(0x8D, 0xE9, 0xDF),
            ...
            ,
            new Training() { Id = TrainingKind.Cxworx, Name = "CXWORX", Color = Color.FromRgb(0xF3, 0xE4, 0xC7),
                Description = "Exercising muscles around the core."
            },
            new Training() { Id = TrainingKind.BodyPump, Name = "BodyPump", Color = Color.FromRgb(0xF4, 0xCE, 0x93),
                Description = "BodyPump is a barbell workout for anyone looking to get lean, toned and fit – fast."
            },
            new Training() { Id = TrainingKind.Pilates, Name = "Pilates", Color = Color.FromRgb(0xC7, 0xF4, 0xFF),
            ...
            new Training() { Id = TrainingKind.Abl, Name = "ABL", Color = Color.FromRgb(0xCF, 0xDB, 0x98),
            ...
            new Training() { Id = TrainingKind.Tabata, Name = "Tabata", Color = Color.FromRgb(0xE0, 0xCF, 0xE9),
            ...
            new Training() { Id = TrainingKind.PrivateTraining, Name = "Private Training", Color = Color.FromRgb(0xFF, 0xF7, 0xA5) },
        };
