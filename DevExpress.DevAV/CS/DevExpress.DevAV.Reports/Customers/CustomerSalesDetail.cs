    ...
    public class CustomerSalesDetail : DevExpress.XtraReports.UI.XtraReport {
        ...
        void UpdateChartFilter() {
            xrChart1.Series[0].FilterCriteria = new GroupOperator(
                new BinaryOperator("Order.OrderDate", paramFromDate.Value, BinaryOperatorType.GreaterOrEqual),
                new BinaryOperator("Order.OrderDate", paramToDate.Value, BinaryOperatorType.LessOrEqual)
            );
        }
