...
Namespace DevExpress.DevAV.ViewModels
  ...
  Public Partial Class DevAVDbViewModel
    ...
    Private ReadOnly Property EmployeeIcon As ImageSource
      Get
        Return CType(New SvgImageSourceExtension() With {.Uri = New Uri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/NewEmploye.svg")}.ProvideValue(Nothing), ImageSource)
      End Get
    End Property
    Private ReadOnly Property CustomerIcon As ImageSource
      Get
        Return CType(New SvgImageSourceExtension() With {.Uri = New Uri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/NewCustomer.svg")}.ProvideValue(Nothing), ImageSource)
      End Get
    End Property
    Private ReadOnly Property OpportunitiesIcon As ImageSource
      Get
        Return CType(New SvgImageSourceExtension() With {.Uri = New Uri("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/NewOpportunities.svg")}.ProvideValue(Nothing), ImageSource)
      End Get
    End Property
  End Class
  Public Partial Class DevAVDbModuleDescription
    ...
    Public Sub New(ByVal title As String, ByVal documentType As String, ByVal group As String, ByVal filterTreeViewModel As IFilterTreeViewModel, Optional ByVal peekCollectionViewModelFactory As Func(Of DevAVDbModuleDescription, Object) = Nothing)
      ...
      _ImageSource = CType(New SvgImageSourceExtension() With {.Uri = New Uri(String.Format("pack://application:,,,/DevExpress.OutlookInspiredApp.Wpf;component/Resources/Modules/{0}.svg", title)), .Size = New System.Windows.Size(24, 24)}.ProvideValue(Nothing), ImageSource)
