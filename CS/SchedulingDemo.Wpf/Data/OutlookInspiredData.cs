...
namespace SchedulingDemo {
    ...
    public class OutlookInspiredData {
        ...
        OutlookEvent CreateEvent(TeamAppointment appt, int? calendarId, int categoryId) {
            ...
            outlookEvent.CalendarId = calendarId;
    ...
    public class Calendar {
        ...
        public static Calendar Create(string group, string caption) {
            return ViewModelSource.Create(() => new Calendar() {
                Group = group,
                Caption = caption,
                IsVisible = true,
            });
    ...
    public class OutlookEvent {
        public static OutlookEvent Create() {
            return ViewModelSource.Create(() => new OutlookEvent());
        }
    ...
    public class CheckedCategory {
        public static CheckedCategory Create(AppointmentLabelItem category, bool isChecked) {
            return ViewModelSource.Create(() => new CheckedCategory(category, isChecked));
        }
