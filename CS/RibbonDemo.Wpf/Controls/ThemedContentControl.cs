...
namespace RibbonDemo {
    public class ThemedContentControl : ContentControl {
        ...
        bool IsDarkTheme { get { 
                return ApplicationThemeHelper.ApplicationThemeName == Theme.MetropolisDarkName 
                    || ApplicationThemeHelper.ApplicationThemeName == Theme.TouchlineDarkName 
                    || ApplicationThemeHelper.ApplicationThemeName == Theme.Office2016DarkGraySEName; }}
        #endregion
