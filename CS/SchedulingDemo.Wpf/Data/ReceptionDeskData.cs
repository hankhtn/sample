...
namespace SchedulingDemo {
    ...
    public class MedicalAppointmentType {
        public static MedicalAppointmentType Create() {
            return ViewModelSource.Create(() => new MedicalAppointmentType());
        }
    ...
    public class ReceptionDeskData {
        ...
        public static SolidColorBrush[] PaymentBrushStates = { BrushesCache.GetBrush(Color.FromRgb(0xec, 0x70, 0x63)), BrushesCache.GetBrush(Color.FromRgb(0x45, 0xb3, 0x9d)) };
        ...
        void CreateDoctors() {
            ...
            foreach (HospitalDepartment hospitalDepartment in HospitalDepartments) {
                ...
                for (int i = 0; i < medicCount; i++) {
                    ...
                    doctor.Photo = new BitmapImage(new Uri(string.Format("pack://application:,,,/SchedulingDemo;component/{0}", imageName)));
                    doctor.Photo.Freeze();
                    doctors.Add(doctor);
