...
namespace GridDemo {
    public static class IssuesService {
        ...
        public static Task<IssueData[]> GetIssuesAsync(int page, int pageSize, IssueSortOrder sortOrder, IssueFilter filter) {
        ...
        public static Task<IssuesSummaries> GetSummariesAsync(IssueFilter filter) {
            return System.Threading.Tasks.Task.Factory.StartNew(() => {
                Thread.Sleep(300);
