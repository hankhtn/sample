...
Namespace DiagramDemo
    Public NotInheritable Class RestrictedPartOfTheCanvasExample
        ...
        Public Shared Function Run() As FrameworkElement
            ...
            Dim restrictedPartMarker As New DiagramShape() With {.Position = New Point(180, 50), .Width = 180, .Height = 200, .StrokeDashArray = New DoubleCollection( { 8R, 8R }), .Stroke = New SolidColorBrush(Color.FromRgb(&HC8, &H14, &H14)), .Background = Brushes.Transparent, .StrokeThickness = 3}
