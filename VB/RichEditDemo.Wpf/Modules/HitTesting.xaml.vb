...
Namespace RichEditDemo
    Partial Public Class HitTesting
        ...
        Private _highlightOptions As New Dictionary(Of LayoutType, RichEditPen)()
        ...
        Private Sub RichEditControl_BeforePagePaint(ByVal sender As Object, ByVal e As BeforePagePaintEventArgs)
            ...
            End If
        End Sub
        Private Sub HitTest(ByVal point As System.Drawing.Point)
            ...
            Dim position As System.Drawing.Point = pageLayoutPosition.Position
            Dim page As LayoutPage = RichEditControl.DocumentLayout.GetPage(CurrentPageIndex)
            Dim hitTestManager As New HitTestManager(richEdit.DocumentLayout)
            ...
            Select Case CType(cbScope.EditValue, ScopeType)
                ...
                Case ScopeType.FooterPageArea
                    If page.Footer IsNot Nothing Then
        ...
        Private Sub RichEditControl_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Input.MouseEventArgs)
            ...
            If MousePosition <> position Then
                HitTest(New System.Drawing.Point(CInt((position.X)), CInt((position.Y))))
                RichEditControl.Refresh()
                MousePosition = position
            End If
        End Sub
        Private Function Concat(ByVal c As Char, ByVal count As Integer) As String
            Dim builder As New StringBuilder(count)
            builder.Append(c, count)
            Return builder.ToString()
        End Function
        Private Sub RichEditControl_MouseLeftButtonUp(ByVal sender As Object, ByVal e As System.Windows.Input.MouseButtonEventArgs)
            lbResult.Items.Clear()
            Dim reversedResult As RichEditHitTestResult = RichEditHitTestResult.Reverse(HitTestResult)
            Dim i As Integer = 0
            Do While reversedResult IsNot Nothing
