...
Namespace RichEditDemo
    Public Class RichEditOptionsProvider
        ...
        Public Sub New(ByVal options As RichEditControlOptions)
            Me._clipboardOptionsProvider = New RichEditClipboardOptionsProvider(options.Behavior)
            Me._commonOptionsProvider = New RichEditCommonOptionsProvider(options.Behavior)
            Me._zoomOptionsProvider = New RichEditZoomOptionsProvider(options.Behavior)
            Me._miscellaneousOptionsProvider = New RichEditMiscellaneousOptionsProvider(options.Behavior)
            Me._documentCapabilitiesOptionsProvider = New RichEditDocumentCapabilitiesOptionsProvider(options.DocumentCapabilities)
        End Sub
    ...
    Public Class RichEditDocumentCapabilitiesOptionsProvider
        ...
        Public Sub New(ByVal options As DocumentCapabilitiesOptions)
            Me._options = options
            Me._numberingOptionsProvider = New RichEditNumberingOptionsProvider(options.Numbering)
        End Sub
