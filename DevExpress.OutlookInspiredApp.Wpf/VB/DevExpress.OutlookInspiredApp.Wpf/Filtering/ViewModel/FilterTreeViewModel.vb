...
Namespace DevExpress.DevAV.ViewModels
    Public Class FilterTreeViewModel(Of TEntity As Class, TPrimaryKey)
        ...
        Protected Sub New(ByVal settings As IFilterTreeModelPageSpecificSettings, ByVal entities As IQueryable(Of TEntity), ByVal registerEntityChangedMessageHandler As Action(Of Object, Action))
            ...
            Categories = New ObservableCollection(Of FilterCategory)() From {
                New FilterCategory(StaticCategoryName, Me, StaticFilters),
                New FilterCategory(CustomCategoryName, Me, CustomFilters, isCustom:=True)
            }
        End Sub

        Public Overridable Property Categories() As ObservableCollection(Of FilterCategory)
        ...
        Private privateWarningParameterName As String
        Public Property WarningParameterName() As String
            Get
                Return privateWarningParameterName
            End Get
            Private Set(ByVal value As String)
                privateWarningParameterName = value
            End Set
        End Property
        ...
        Private Sub UpdateFilters()
            For Each item In StaticFilters.Concat(CustomFilters)
                Dim entityCount = GetEntityCount(item.FilterCriteria)
                If item.Name = WarningParameterName Then
        ...
        Private Function CreateFilterItem(ByVal name As String, ByVal filterCriteria As CriteriaOperator, ByVal imageUri As String) As FilterItem
            Return FilterItem.Create(GetEntityCount(filterCriteria), name, filterCriteria, imageUri, Me)
        End Function
        ...
        Private ReadOnly Property IFilterTreeViewModel_Categories() As ObservableCollection(Of FilterCategory) Implements IFilterTreeViewModel.Categories
            Get
                Return Categories
            End Get
        End Property
    ...
    Public Class FilterCategory
        ...
        Public Property FilterTreeViewModel() As IFilterTreeViewModel
            ...
            End Set
        End Property
        Private privateFilterItems As ObservableCollection(Of FilterItem)
        Public Property FilterItems() As ObservableCollection(Of FilterItem)
            Get
                Return privateFilterItems
            End Get
            Private Set(ByVal value As ObservableCollection(Of FilterItem))
        ...
        Public Sub New(ByVal name As String, ByVal filterTreeViewModel_Renamed As IFilterTreeViewModel, ByVal filterItems As ObservableCollection(Of FilterItem), Optional ByVal isCustom As Boolean = False)
            Me.Name = name
    ...
    Public Interface IFilterTreeViewModel
        ...
        ReadOnly Property Categories() As ObservableCollection(Of FilterCategory)
    End Interface
End Namespace
