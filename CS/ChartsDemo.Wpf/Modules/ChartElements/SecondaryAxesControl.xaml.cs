...
namespace ChartsDemo {
    [CodeFile("Modules/ChartElements/SecondaryAxesControl.xaml"),
    ...
    public partial class SecondaryAxesControl : ChartsDemoModule {
        ...
        XYSeries2D FirstSeries { get { return chart.Diagram.Series.Count > 0 ? (XYSeries2D)chart.Diagram.Series[0] : null; } }
        XYSeries2D SecondSeries { get { return chart.Diagram.Series.Count > 1 ? (XYSeries2D)chart.Diagram.Series[1] : null; } }
        ...
        void SecondaryAxesControl_ModuleLoaded(object sender, RoutedEventArgs e) {
            chart.Animate();
            firstRun = false;
        }
