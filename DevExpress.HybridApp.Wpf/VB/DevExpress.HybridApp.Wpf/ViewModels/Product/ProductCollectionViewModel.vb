...
Namespace DevExpress.DevAV.ViewModels
  ...
  Public Partial Class ProductCollectionViewModel
    Inherits CollectionViewModel(Of Product, ProductInfoWithSales, long, IDevAVDbUnitOfWork)    
    ''' <summary>
    ...
    Protected Sub New(Optional ByVal unitOfWorkFactory As IUnitOfWorkFactory(Of IDevAVDbUnitOfWork) = Nothing, Optional ByVal unitOfWorkPolicy As UnitOfWorkPolicy = UnitOfWorkPolicy.Individual)
      MyBase.New(If(unitOfWorkFactory, UnitOfWorkSource.GetUnitOfWorkFactory()), Function(ByVal x) x.Products, Function(ByVal query) QueriesHelper.GetProductInfoWithSales(query), unitOfWorkPolicy := unitOfWorkPolicy)
    End Sub
  End Class
End Namespace
