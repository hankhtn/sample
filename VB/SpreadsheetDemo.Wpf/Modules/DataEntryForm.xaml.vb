...
Namespace SpreadsheetDemo
    Partial Public Class DataEntryForm
        ...
        Private Sub RemoveOrderItem(ByVal sheet As Worksheet, ByVal rowIndex As Integer)
            ...
            If invoiceItems IsNot Nothing AndAlso rowIndex > invoiceItems.Range.BottomRowIndex Then
        ...
        Private Sub spreadsheetControl1_PreviewMouseLeftButtonDown(ByVal sender As Object, ByVal e As System.Windows.Input.MouseButtonEventArgs)
            Dim cell As Cell = spreadsheetControl1.GetCellFromPoint(e.GetPosition(spreadsheetControl1).ToDrawingPoint())
            If cell Is Nothing OrElse cell.Worksheet.Name <> "Invoice" Then
                Return
            End If
    ...
    Public Class ManageOrderItemTemplateSelector
        ...
        Public Overrides Function SelectTemplate(ByVal item As Object, ByVal container As DependencyObject) As DataTemplate
            ...
            If CanApplyDeleteOrderItemTemplate(data.Cell) Then
                Return TryCast(control.TryFindResource("DeleteOrderItemTemplate"), DataTemplate)
            End If
            If CanApplyAddOrderItemTemplate(data.Cell) Then
                Return TryCast(control.TryFindResource("AddOrderItemTemplate"), DataTemplate)
            End If
        ...
        Private Function CanApplyAddOrderItemTemplate(ByVal cell As Cell) As Boolean
            ...
            End If
            Dim invoiceItems As DefinedName = sheet.DefinedNames.GetDefinedName("InvoiceItems")
            Return cell.ColumnIndex = 6 AndAlso cell.RowIndex = (If(invoiceItems Is Nothing, 21, invoiceItems.Range.BottomRowIndex + 1))
        End Function
        ...
        Private Function CanApplyDeleteOrderItemTemplate(ByVal cell As Cell) As Boolean
            ...
            End If
            Dim invoiceItems As DefinedName = sheet.DefinedNames.GetDefinedName("InvoiceItems")
            Return invoiceItems IsNot Nothing AndAlso cell.ColumnIndex = 10 AndAlso invoiceItems.Range.RowCount > 1 AndAlso cell.RowIndex >= invoiceItems.Range.TopRowIndex AndAlso cell.RowIndex <= invoiceItems.Range.BottomRowIndex
        End Function
    End Class
