...
Namespace GridDemo
    ...
    Public Class PLinqInstantFeedbackDemoViewModel
        ...
        Private listCache As New ConcurrentDictionary(Of Integer, IList)()
        Private Function GetOrders() As IList
            Dim actualCount = If(ViewModelBase.IsInDesignMode, 0, Count)
            Return listCache.GetOrAdd(actualCount, Function(count) OrderDataGenerator.GenerateOrders(count))
        End Function
    End Class
End Namespace
