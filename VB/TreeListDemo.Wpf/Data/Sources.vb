...
Namespace TreeListDemo
        ...
        Public Shared ReadOnly Property DataSource() As IList
            Get
                If dataSource_Renamed IsNot Nothing Then
                    Return dataSource_Renamed
                End If
                Dim assembly As System.Reflection.Assembly = GetType(EmployeedTasks).Assembly
                ...
                Dim s As New XmlSerializer(GetType(EmployeedTasks), New XmlRootAttribute("EmployeeTasks"))
                dataSource_Renamed = DirectCast(s.Deserialize(stream), IList)
                Return dataSource_Renamed
            End Get
        End Property
    ...
    Public Class PriorityIconConverter
        ...
        Private Shared PriorityImages As List(Of BitmapImage)
        Shared Sub New()
            PriorityImages = New List(Of BitmapImage)()
            PriorityImages.Add(New BitmapImage(New Uri("/TreeListDemo;component/Images/Flag_Yellow.png", UriKind.Relative)))
            PriorityImages.Add(New BitmapImage(New Uri("/TreeListDemo;component/Images/Flag_Red.png", UriKind.Relative)))
        End Sub
