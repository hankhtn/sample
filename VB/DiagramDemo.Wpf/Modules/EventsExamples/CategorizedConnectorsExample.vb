...
Namespace DiagramDemo
    Public NotInheritable Class CategorizedConnectorsExample
        ...
        Public Shared Function Run() As FrameworkElement
            ...
            AddHandler diagram.QueryConnectionPoints, Sub(sender, e)
                If e.OppositeItem IsNot Nothing AndAlso e.OppositeItem.Background.ToString() <> e.HoveredItem.Background.ToString() Then
                    e.ItemConnectionBorderState = ConnectionElementState.Hidden
            ...
            diagram.Items.Add(New DiagramShape() With {.Position = New Point(50, 40), .Width = 120, .Height = 50, .Background = New SolidColorBrush(Color.FromRgb(&H1, &H73, &HC7))})
            diagram.Items.Add(New DiagramShape() With {.Position = New Point(230, 120), .Width = 120, .Height = 50, .Background = New SolidColorBrush(Color.FromRgb(&H1, &H73, &HC7))})
            diagram.Items.Add(New DiagramShape() With {.Position = New Point(50, 200), .Width = 120, .Height = 50, .Background = New SolidColorBrush(Color.FromRgb(&H1, &H73, &HC7))})
            diagram.Items.Add(New DiagramShape() With {.Position = New Point(230, 40), .Width = 120, .Height = 50, .Background = New SolidColorBrush(Color.FromRgb(&HC7, &H73, &H1))})
            diagram.Items.Add(New DiagramShape() With {.Position = New Point(50, 120), .Width = 120, .Height = 50, .Background = New SolidColorBrush(Color.FromRgb(&HC7, &H73, &H1))})
            diagram.Items.Add(New DiagramShape() With {.Position = New Point(230, 200), .Width = 120, .Height = 50, .Background = New SolidColorBrush(Color.FromRgb(&HC7, &H73, &H1))})
