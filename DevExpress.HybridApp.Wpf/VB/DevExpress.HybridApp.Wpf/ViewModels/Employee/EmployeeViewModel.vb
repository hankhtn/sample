...
Namespace DevExpress.DevAV.ViewModels
  ...
  Public Partial Class EmployeeViewModel
    ...
    Public ReadOnly Property EmployeeAssignedTasksDetails As CollectionViewModelBase(Of EmployeeTask, EmployeeTask, long, IDevAVDbUnitOfWork)
      Get
        Return GetDetailsCollectionViewModel(Of EmployeeViewModel, EmployeeTask, long, long?)(propertyExpression := Function(ByVal x As EmployeeViewModel) x.EmployeeAssignedTasksDetails, getRepositoryFunc := Function(ByVal x) x.Tasks, foreignKeyExpression := Function(ByVal x) x.AssignedEmployeeId, navigationExpression := Function(ByVal x) x.AssignedEmployee)
      End Get
    End Property    
    ''' <summary>
