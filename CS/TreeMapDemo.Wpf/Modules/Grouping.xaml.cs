...
namespace TreeMapDemo {
    ...
    public class GrouppingViewModel : ViewModelBase {
        static GrouppingViewModel instance;

        public static GrouppingViewModel Instance {
            get {
                if(instance == null)
                    instance = ViewModelSource.Create(() => new GrouppingViewModel());
                return instance;
            }
        }
