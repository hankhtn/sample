...
Namespace DevExpress.DevAV.ViewModels
    Public NotInheritable Class ReportInfoFactory
        ...
        Public Shared Function SalesRevenueReport(ByVal sales As IEnumerable(Of OrderItem)) As IReportInfo
        ...
        End Function
        Public Shared Function SalesRevenueAnalysisReport(ByVal sales As IEnumerable(Of OrderItem)) As IReportInfo
    ...
    Public Class SelectYearsViewModel
        ...
        End Function
        Protected Sub New()
            AvailableYears = New List(Of String)() From {"2015", "2016", "2017", "2018"}
            Years = "2015,2016"
        End Sub
    ...
    Public Class InvoiceOptionsViewModel
        ...
        End Function
        Protected Sub New()
            AvailableOptions = New List(Of Tuple(Of String, String))() From {
                New Tuple(Of String, String)("ShowHeader", "Show Header"),
                New Tuple(Of String, String)("ShowFooter", "Show Footer"),
                New Tuple(Of String, String)("ShowStatus", "Show Status"),
                New Tuple(Of String, String)("ShowComments", "Show Comments")
            }
        ...
        Public Function IsOptionSelected(ByVal id As String) As Boolean
            If SelectedOptions Is Nothing Then
                Return False
            End If
            Return SelectedOptions.Cast(Of Tuple(Of String, String))().Any(Function(x) Object.Equals(x.Item1, id))
        End Function
    End Class
