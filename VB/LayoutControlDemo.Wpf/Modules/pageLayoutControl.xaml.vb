...
Namespace LayoutControlDemo
    Partial Public Class pageLayoutControl
        ...
        Private Sub LayoutGroupHeaderTextEdit_EditValueChanging(ByVal sender As Object, ByVal e As EditValueChangingEventArgs)
            ...
            If textBox.EditValue IsNot Nothing AndAlso Equals(textBox.EditValue, e.NewValue) AndAlso (Not parentLayoutGroup.View.Equals(LayoutGroupView.Tabs)) Then
    ...
    Public Class LayoutControlTemplateSelector
        ...
        Public Overrides Function SelectTemplate(ByVal item As Object, ByVal container As DependencyObject) As DataTemplate
            If TypeOf item Is LayoutGroup Then
                Return LayoutGroupTemplate
            End If
            If TypeOf item Is LayoutItem Then
                Return LayoutItemTemplate
            End If
            If TypeOf item Is TextEdit OrElse TypeOf item Is SampleLayoutItem Then
