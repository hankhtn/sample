...
namespace SchedulingDemo {
    ...
    public class SportChannelsData {
        public static readonly SportGroup[] SportGroups = {
            ...
            new SportGroup() { Id = 1, Caption = "Basketball", Color = Color.FromRgb(0xFF, 0xC2, 0xBE), Image = CreateSportGroupImageSource("Basketball") },
            new SportGroup() { Id = 2, Caption = "Boxing", Color = Color.FromRgb(0xA8, 0xD5, 0xFF), Image = CreateSportGroupImageSource("Boxing") },
            new SportGroup() { Id = 3, Caption = "Tennis", Color = Color.FromRgb(0xC1, 0xF4, 0x9C), Image = CreateSportGroupImageSource("Tennis") },
            new SportGroup() { Id = 4, Caption = "Soccer", Color = Color.FromRgb(0xF3, 0xE4, 0xC7), Image = CreateSportGroupImageSource("Soccer") },
            new SportGroup() { Id = 5, Caption = "Artistic Gymnastics", Color = Color.FromRgb(0xF4, 0xCE, 0x93), Image = CreateSportGroupImageSource("Artistic Gymnastics") },
            new SportGroup() { Id = 6, Caption = "Canoe", Color = Color.FromRgb(0xC7, 0xF4, 0xFF), Image = CreateSportGroupImageSource("Canoe") },
            new SportGroup() { Id = 7, Caption = "Kayak", Color = Color.FromRgb(0xCF, 0xDB, 0x98), Image = CreateSportGroupImageSource("Kayak") },
            new SportGroup() { Id = 8, Caption = "Sailing", Color = Color.FromRgb(0xE0, 0xCF, 0xE9), Image = CreateSportGroupImageSource("Sailing") },
            new SportGroup() { Id = 9, Caption = "Swimming", Color = Color.FromRgb(0x8D, 0xE9, 0xDF), Image = CreateSportGroupImageSource("Swimming") },
            new SportGroup() { Id = 10, Caption = "Shooting", Color = Color.FromRgb(0xFF, 0xF7, 0xA5), Image = CreateSportGroupImageSource("Shooting") },
        };
        ...
        static ImageSource CreateSportGroupImageSource(string caption) {
            ...
            ImageSource sportImage = new BitmapImage(new Uri(string.Format("pack://application:,,,/SchedulingDemo;component/{0}", imageName)));
            sportImage.Freeze();
            return sportImage;
        }
