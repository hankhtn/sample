...
Namespace GridDemo
    Public NotInheritable Class ProductSaleDataGenerator

        Private Sub New()
        End Sub

        Public Shared Function GenerateSales(ByVal count As Integer) As List(Of ProductSaleData)
        ...
        End Function
        Private Shared Function CreateSale(ByVal random As Random, ByVal country As String, ByVal product As String, ByVal year As Integer) As ProductSaleData
