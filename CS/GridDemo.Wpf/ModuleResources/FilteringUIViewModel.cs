...
namespace GridDemo {
    ...
    public class VehiclesFilteringViewModel {
        ...
        [FilterLookup("TransmissionTypes", DisplayMember = "Name", ValueMember = "ID", SelectionMode = ValueSelectionMode.Single, UseSelectAll = true)]
        ...
        [Display(Name = "Doors")]
        [FilterLookup("DoorTypes", SelectionMode = ValueSelectionMode.Single, UseSelectAll = true )]
