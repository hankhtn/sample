...
Namespace DevExpress.DevAV
    Public Class MasterDetailRichEditBehavior
        ...
        Private Sub OnCalculateDocumentVariable(ByVal sender As Object, ByVal e As CalculateDocumentVariableEventArgs)
            If Order Is Nothing OrElse e.VariableName <> "Products" Then
                Return
            End If
            Using server = New RichEditDocumentServer()
                Using stream = MailMergeTemplatesHelper.GetTemplateStream("Sales Order Follow-Up Detail.rtf")
        ...
        Private Sub OnOrderChanged()
            If Order Is Nothing OrElse richEdit Is Nothing Then
                Return
            End If
            Using stream = MailMergeTemplatesHelper.GetTemplateStream("Sales Order Follow-Up.rtf")
