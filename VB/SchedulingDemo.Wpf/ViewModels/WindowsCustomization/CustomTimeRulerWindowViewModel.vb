...
Namespace SchedulingDemo.ViewModels
    Public Class CustomTimeRulerWindowViewModel
        ...
        Public Property ShowMinutes() As Boolean
            Get
                Return GetProperty(Function() ShowMinutes)
            End Get
        ...
        Public Property AlwaysShowTimeDesignator() As Boolean
            Get
                Return GetProperty(Function() AlwaysShowTimeDesignator)
            End Get
            Set(ByVal value As Boolean)
        ...
        Protected Overrides Sub Save()
            MyBase.Save()
            Me.timeRuler.ShowMinutes = ShowMinutes
            Me.timeRuler.AlwaysShowTimeDesignator = AlwaysShowTimeDesignator
        End Sub
