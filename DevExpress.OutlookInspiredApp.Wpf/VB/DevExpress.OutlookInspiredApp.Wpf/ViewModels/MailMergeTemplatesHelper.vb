...
Namespace DevExpress.DevAV.ViewModels
    ...
    Public NotInheritable Class MailMergeTemplatesHelper
        ...
        Private Shared templateNames() As String = { "Employee of the Month.rtf", "Employee Probation Notice.rtf", "Employee Service Excellence.rtf", "Employee Thank You Note.rtf", "Welcome to DevAV.rtf" }
