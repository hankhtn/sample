...
Namespace DevExpress.DevAV.ViewModels
  ...
  Public Partial Class CustomerCollectionViewModel
    Inherits CollectionViewModel(Of Customer, CustomerInfoWithSales, long, IDevAVDbUnitOfWork)    
    ''' <summary>
    ...
    Protected Sub New(Optional ByVal unitOfWorkFactory As IUnitOfWorkFactory(Of IDevAVDbUnitOfWork) = Nothing, Optional ByVal unitOfWorkPolicy As UnitOfWorkPolicy = UnitOfWorkPolicy.Individual)
      MyBase.New(If(unitOfWorkFactory, UnitOfWorkSource.GetUnitOfWorkFactory()), Function(ByVal x) x.Customers, Function(ByVal query) QueriesHelper.GetCustomerInfoWithSales(query), unitOfWorkPolicy := unitOfWorkPolicy)
    End Sub
  End Class
End Namespace
