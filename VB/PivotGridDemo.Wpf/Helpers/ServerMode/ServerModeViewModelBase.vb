...
Namespace PivotGridDemo
    Public Class ServerModeViewModelBase(Of T As Class)
        ...
        Public Class GenerateDataViewModel
            ...
            Private privateStopGeneratingData As Boolean
            Friend Property StopGeneratingData() As Boolean
                Get
                    Return privateStopGeneratingData
                End Get
                Private Set(ByVal value As Boolean)
                    privateStopGeneratingData = value
                End Set
            End Property
        ...
        Private Sub ContinueWithAssignSources(ByVal task As System.Threading.Tasks.Task)
        ...
        Private Function GetOrCreateGenerateViewModel() As GenerateDataViewModel
            If GenerateViewModel Is Nothing Then
