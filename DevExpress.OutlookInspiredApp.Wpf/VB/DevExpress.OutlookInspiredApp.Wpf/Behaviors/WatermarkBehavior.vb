        ...
        Private Shared Sub AddWatermark(ByVal processor As PdfDocumentProcessor, ByVal watermark As String)
            ...
            For i As Integer = 0 To pages.Count - 1
                Using graphics = processor.CreateGraphics()
                    Using font As New Font("Segoe UI", 48, System.Drawing.FontStyle.Regular)
                        Dim pageLayout As New RectangleF(-CSng(pages(i).CropBox.Width) * 0.35F, CSng(pages(i).CropBox.Height) * 0.1F, CSng(pages(i).CropBox.Width) * 1.25F, CSng(pages(i).CropBox.Height))
