...
namespace RibbonDemo {
    ...
    public class MyParentCommand : CommandModel {
        ...
        private void PageGroupCreation() {
            viewModel.Categories[0].Pages[0].Groups.Add(ViewModelSource.Create(() => new PageGroupModel() { Name = "New Group", Glyph = GlyphHelper.GetGlyph("/Images/Icons/NewViaWizard_32x32.png") }));
        }
        private void CommandCreation() {
            CommandModel newCommand = ViewModelSource.Create(() => new CommandModel() { Caption = "New Command", LargeGlyph = GlyphHelper.GetGlyph("/Images/Icons/NewViaWizard_32x32.png"), SmallGlyph = GlyphHelper.GetGlyph("/Images/Icons/NewViaWizard_16x16.png") });
