...
Namespace GridDemo.ModuleResources
    Friend NotInheritable Class CardViewExplorerIconManager
        ...
        Private Shared Function IconSource(ByVal ic As Icon, ByVal size As SizeIcon, ByVal maybeMinIcon As Boolean) As BitmapSource
        ...
        Private Shared Function IconByte(ByVal ic As Icon, ByVal size As SizeIcon, ByVal maybeMinIcon As Boolean) As Byte()
            Dim converter As New ImageConverter()
            Return DirectCast(converter.ConvertTo(GetBitmap(ic, size, maybeMinIcon), GetType(Byte())), Byte())
        End Function

        Private Shared Function GetBitmap(ByVal ic As Icon, ByVal size As SizeIcon, ByVal maybeMinIcon As Boolean) As Bitmap
        ...
        Public Shared Function GetLargeIcon(ByVal fileName As String, ByVal maybeSmall As Boolean, Optional ByVal sizeIcon As SizeIcon = SizeIcon.ExtraLarge) As BitmapSource
        ...
        Public Shared Function GetLargeIconByte(ByVal fileName As String, ByVal maybeSmall As Boolean, Optional ByVal sizeIcon As SizeIcon = SizeIcon.ExtraLarge) As Byte()
            Try
                Dim hIcon As IntPtr = Nothing
                Dim icon As Icon = GetFileIcon(fileName, hIcon)
