...
Namespace WindowsUIDemo
    Partial Public Class ImageViewer
        ...
        Public Shared ReadOnly ImageSourceProperty As DependencyProperty = DependencyProperty.Register("ImageSource", GetType(ImageSource), GetType(ImageViewer), New PropertyMetadata(Nothing))
